...
@Repository
@Profile({ "dev", "test" })
public class IvisiterDaoImplMYSQL implements IvisiterDao {

	public IvisiterDaoImplMYSQL() {
		System.out.println("IvisiterDaoImplMYSQL.IvisiterDaoImplMYSQL()");
	}
	...
	public List<Visiter> GetVisiterVisiteState(String dist1, String dist2, String dist3) throws Exception {
		System.out.println("IvisiterDaoImplMYSQL.GetVisiterVisiteState()");
